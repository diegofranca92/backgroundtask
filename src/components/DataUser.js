...
import { View, StyleSheet, Text, FlatList, Image, KeyboardAvoidingView, TextInput, SafeAreaView, TouchableOpacity, TouchableHighlight, Platform, ScrollView, RefreshControl, Picker } from 'react-native';
...
function DataUser({navigation, action}) {
  ...
  async function submitUpdateUser() {
    if(name && email && cpf && cnh && celular && dataNascimento && nomeMae && cidade && fotoRosto.uri !== "" && fotoCnh.uri !== "" && fotoComprovante.uri !== ""){
      if(validateEmail(email)){
          ...
          formData.append('nr_whatsapp', whatsapp !== null ? whatsapp.replace("(", "").replace(")", "").replace(" ", "").replace("-", "") : '');
  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false}>
      ...
      <View enabled={true} behavior="padding" style={loading ? styles.hidden : styles.container}>
        <View style={styles.form}>
          ...
          <TouchableOpacity onPress={uploadComprovante} style={fotoComprovante.uri === "" ? styles.buttonUpload : styles.hidden}>
          ...
          <TouchableOpacity onPress={uploadFotoPerfil} style={fotoRosto.uri === "" ? styles.buttonUpload : styles.hidden}>
